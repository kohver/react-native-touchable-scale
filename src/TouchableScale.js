...
export default class TouchableScale extends React.Component {
  ...
  onPressIn(...args) {
    ...
    const props = this.props
    const tension =
      typeof props.pressInTension !== 'undefined' ? props.pressInTension : props.tension
    const friction =
      typeof props.pressInFriction !== 'undefined' ? props.pressInFriction : props.friction
  ...
  onPressOut(...args) {
    ...
    const props = this.props
    const tension =
      typeof props.pressOutTension !== 'undefined' ? props.pressOutTension : props.tension
    const friction =
      typeof props.pressOutFriction !== 'undefined' ? props.pressOutFriction : props.friction
